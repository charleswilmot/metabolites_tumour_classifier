...
mode = "testing_given_specific_pretrained"
...
if mode == "single_runs":
    ...
    data_mode = "mnist"   # "metabolites"
    pretrained_dirs = []
    if data_mode == "mnist":
        pretrained_dirs = [
            "/home/epilepsy-data/data/metabolites/2020-08-30-restuls_after_review/old-mnist-single-ep-training-MLP/2021-03-01T15-40-45--MLP-both_meanx0-factor-0-from-mnist-ctFalse-theta-1-s6617-train-lbInd-1/network"
            ]
        data_source_dirs = ["/home/epilepsy-data/data/metabolites/2020-08-30-restuls_after_review/old-mnist-single-ep-training-MLP/0.2_noisy_test_mnist_[samp_id,true,noise,feature]-s6617.csv"] * len(pretrained_dirs)
    elif data_mode == "metabolites":
        pretrained_dirs = [
